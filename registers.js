...
export const CONFIG_REGISTERS = {
  BASIC: [
    { id: '01', address: 0xE204, name: 'AC Output Mode', key: 'outputPriority', scale: 1, unit: '', min: 0, max: 2, description: '0:UTI 1:SBU 2:SBU' },
    { id: '38', address: 0xE208, name: 'AC Output Voltage', key: 'outputVolt', scale: 0.1, unit: 'V', min: 100, max: 264, description: '100/105/110/120/127 VAC' },
    { id: '02', address: 0xE209, name: 'AC Input Frequency', key: 'outputFreq', scale: 0.01, unit: 'Hz', min: 45, max: 65, description: '50Hz or 60Hz' },
    { id: '03', address: 0xE20B, name: 'AC Input Voltage Range', key: 'acVoltRange', scale: 1, unit: '', min: 0, max: 1, description: '0:APL (Wide) 1:UPS (Narrow)' },
    { id: '22', address: 0xE20C, name: 'Energy-Saving Mode', key: 'powerSaving', scale: 1, unit: '', min: 0, max: 1, description: 'Off below 50W after 5min' },
  ...
  BATTERY: [
    ...
    { id: '—', address: 0xE003, name: 'System Voltage', key: 'batVoltage', scale: 1, unit: 'V', min: 12, max: 96, description: '12/24/36/48V' },
    { id: '08', address: 0xE004, name: 'Battery Type', key: 'batType', scale: 1, unit: '', min: 0, max: 14, description: '0:User 1:SLD 2:FLD 3:GEL 4-6:LiFePO4' },
    { id: '32', address: 0xE215, name: 'BMS Communication', key: 'bmsComm', scale: 1, unit: '', min: 0, max: 2, description: '0:Off 1:RS485 2:CAN' },
    { id: '33', address: 0xE21B, name: 'BMS Protocol', key: 'bmsProtocol', scale: 1, unit: '', min: 0, max: 30, description: 'Select protocol (0-30)' },
  ...
  CHARGING: [
    ...
    { id: '20', address: 0xE013, name: 'Equalize Interval', key: 'equalizInterval', scale: 1, unit: 'days', min: 0, max: 255, description: 'Days between equalizations' },
  ...
  SOLAR: [
    { id: '—', address: 0xE039, name: 'PV Power Priority', key: 'pvPriority', scale: 1, unit: '', min: 0, max: 2, description: '0:Charge first 1:Load first' },
  ],
  ...
  GRID: [
    { id: '34', address: 0xE037, name: 'Limit Power to CT', key: 'gridMode', scale: 1, unit: '', min: 0, max: 3, description: '0:Off 1:Home load 2:ACout anti-backfeed 3:ACin anti-backfeed' },
  ...
  GENERATOR: [
    { id: '—', address: 0xE21A, name: 'Generator Charging', key: 'genChgDisable', scale: 1, unit: '', min: 0, max: 1, description: '0:Enabled 1:Disabled' },
